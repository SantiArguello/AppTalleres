				...
				<div className="flex md:mt-0 md:ml-4 space-x-3">
					<Form method="delete">
						<button
							...
							className="flex items-center py-2 px-3 rounded-md shadow-sm text-sm leading-4 font-medium  hover:bg-red-600 hover:text-neutral-100  dark:hover:bg-red-700 outline-none border-none focus:ring-2 focus:ring-red-500">
							<TbUserMinus size={20} />
					...
					<Form>
						<button
							...
							className="flex items-center py-2 px-3 rounded-md shadow-sm text-sm leading-4 font-medium  hover:bg-green-600 hover:text-neutral-100  dark:hover:bg-green-700 outline-none border-none focus:ring-2 focus:ring-green-000">
							<TbUserEdit size={20} />
				...
				<div className=" flex flex-col lg:flex-row text-center lg:text-start lg:justify-between items-center lg:items-start space-y-6 lg:space-y-0">
					...
					<div className="flex justify-center">
						<a
							...
							aria-label="Whatsapp"
							target="_blanck"
							className="relative inline-flex items-center px-4 py-2 border border-neutral-300 dark:border-neutral-500 shadow-sm text-sm font-medium rounded-md hover:bg-green-600 hover:text-neutral-100  focus:outline-none focus:border-none focus:ring-2 focus:ring-green-500 cursor-pointer">
						...
						<a
							...
							className="ml-3 relative inline-flex items-center px-4 py-2 border border-neutral-300 dark:border-neutral-500 shadow-sm text-sm font-medium rounded-md  hover:bg-blue-500 hover:text-neutral-100 focus:outline-none focus:ring-2 focus:border-none focus:ring-blue-500 cursor-pointer">
