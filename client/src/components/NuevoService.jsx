                ...
                <div className='flex items-center p-4'>
                    ...
                    <div className='mt-8 border border-blue-50'>
                        <div className="my-10 flex-col">
                            ...
                            <button
                                type="button"
                                className="bg-blue-500 text-black py-2 px-4 rounded hover:bg-blue-700 mr-2"
                                onClick={handleAddRepuesto}>Agregar Repuesto</button>
                        ...
                        <button
                            type="submit"
                            className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700">Guardar</button>

                        <Link to="/trabajos">
                            <button
                                className="bg-blue-400 text-white py-2 px-4 rounded hover:bg-blue-700">Volver</button></Link>
                    </div>
                </div>
            </form>
        </div>
